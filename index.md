...
- **Nobody else** — our Firebase security rules restrict access to your own data tree (`/users/{your-id}/…`). No other Heirloom user can read your content.
- **Google / Firebase** — our hosting provider stores your data on its servers and processes it solely to provide the service. See Google's privacy policy at https://policies.google.com/privacy.
...
_Heirloom is built with care. Thank you for trusting us with your family's stories._
