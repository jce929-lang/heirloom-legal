...
- You must be at least 13 years old to use the Service. If you are between 13 and the age of majority in your jurisdiction, you must have the permission of a parent or legal guardian.
- You agree that the information you provide during onboarding and in your profile is accurate.
...
- **You own Your Content.** Heirloom does not claim ownership of the stories, videos, or family information you store in the Service.
- **You grant us a limited license** to host, store, transmit, display, and back up Your Content solely to operate and improve the Service for you. This license ends when you delete Your Content or your account.
- **You are responsible for Your Content.** You represent that you have the right to upload it and to share it with the family members you invite, and that doing so does not violate any law or anyone else's rights.
...
- When you invite a storyteller or a viewer, you represent that you have their consent to be contacted via the phone number or email you provide.
- Invitation messages are sent through your device's built-in Messages and Mail apps. Heirloom does not send messages on your behalf from our servers.
- Viewers you invite can see the responses you choose to share with them. Only you can remove a viewer's access.

## 4. Subscription, billing, and trials

- Heirloom offers a free trial and paid subscription plans. Pricing and plan details are shown in the app before purchase.
- Subscriptions are billed through your Apple ID and are managed by Apple. Renewals, refunds, and cancellations follow Apple's standard subscription terms.
- You can manage or cancel your subscription at any time in iOS Settings → Apple ID → Subscriptions. Canceling stops future charges; it does not refund the current period unless Apple grants a refund.
- If your subscription lapses, you retain read-only access to your existing content for a reasonable grace period. New recordings and scheduled prompts require an active subscription.

## 5. Acceptable use

You agree not to:

- Upload content that is illegal, threatening, harassing, defamatory, or that infringes someone else's rights.
- Upload content depicting minors in a sexualized manner or that otherwise violates child-safety laws. We report such content to the authorities.
- Impersonate another person or misrepresent your relationship to a storyteller.
...
Heirloom is a private family app — content is visible only to the people you invite. You can still report objectionable behavior by another Heirloom user (for example, a viewer misusing access) by emailing **safety@getheirloomapp.com**. We respond within 24 hours to credible reports and may remove content or terminate accounts as needed.

## 7. Service availability and changes

- We work hard to keep Heirloom available but do not guarantee uninterrupted service. The Service is provided on an "as-is" basis.
- We may change, suspend, or discontinue features at any time. We will give reasonable notice of material changes that affect how you use the Service.
- We may update the app from time to time. Some updates may be required to keep using the Service.

## 8. Termination

- You can stop using Heirloom at any time by deleting the app and, if you want your data removed, by emailing **privacy@getheirloomapp.com**.
- We may suspend or terminate your account if you violate these Terms, if required by law, or if we cease offering the Service.
- When your account is terminated, your data will be deleted per our Privacy Policy (typically within 30 days).
...
- **Entire agreement.** These Terms and the Privacy Policy are the entire agreement between you and Heirloom regarding the Service.
...
_Thanks for using Heirloom to keep your family's stories alive._- Use automated systems (bots, scrapers) to access the Service.
- Use the Service to violate any applicable law.
...
_Thanks for using Heirloom to keep your family's stories alive._
